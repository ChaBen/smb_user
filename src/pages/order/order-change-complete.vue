<template>
  <div class="content-top">
    ...
    <div class="content mt-0">
      <div class="page-title">일반 주문</div>
      <div class="share-box mt-10">
        <v-layout column>
        ...
        <div class="payment-title mt-20 bt1">함께하는 분들께<br>예약 내용을 공유해보세요!</div>
        <v-btn class="smb-btn" block>예약 내용 공유하기</v-btn>
      </div>
    </div>
    <div class="page-lay" style="margin-top: 30px">
      <v-btn class="page-btn">예약/대기 정보 확인</v-btn>
    </div>
  </div>
</template>
